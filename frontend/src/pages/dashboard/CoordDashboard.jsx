...
import ApprovePendingTutors from "../ApprovePendingTutors";
import MyCreatedProject from "../MyCreatedProject";
import {
  DashboardOutlined,
  TeamOutlined,
...
const StudentDashboard = () => {
  ...
  return (
    <Layout className="coord-first-layout">
      <CustomHeader
      ...
      />
      <Layout className="coord-second-layout relative">
        {isMobile ? (
          <>
            <Drawer
              width="50%"
                ...
                <Col xs={24} sm={12} md={12} lg={8} xl={8}>
                  <Card hoverable onClick={() => handleButtonClick("5")}>
                    <Row wrap={false} align="middle">
                      ...
                      >
                        <Card.Meta title="Supervised Project" />
                      </Col>
                    </Row>
                  </Card>
                </Col>
                <Col xs={24} sm={12} md={12} lg={8} xl={8}>
                  <Card hoverable onClick={() => handleButtonClick("6")}>
                    <Row wrap={false} align="middle">
                      ...
                      >
                        <Card.Meta title="Created Project" />
                      </Col>
                    </Row>
                  </Card>
                </Col>
